...
|---|---|---|---|
| **IEF-PCM** (`ferric-pcm`) | Integral-equation PCM; Bondi radii, atom-centred Lebedev spheres | Python only: `run_rhf(..., solvent=78.4)` or a solvent name; also `run_pdep_rpa`. No `[pcm]` TOML section yet. | water / STO-3G, ε = 78.4: −3.813 vs PySCF IEF-PCM −3.8228 kcal/mol |
