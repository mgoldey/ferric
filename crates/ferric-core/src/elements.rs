...
const ATOMIC_MASSES: &[f64] = &[
    ...
    50.9415,
    51.9961,
    54.938044, // Sc Ti V  Cr Mn
    55.845,
    58.933194,
    58.6934,
    63.546,
    65.38, // Fe Co Ni Cu Zn
    69.723,
    72.63,
    74.921595,
    78.971,
    79.904, // Ga Ge As Se Br
    83.798,
    85.4678,
    87.62,
    88.90584,
    91.224, // Kr Rb Sr Y  Zr
    92.90637,
    95.95,
    97.90721,
    101.07,
    102.9055, // Nb Mo Tc Ru Rh
    106.42,
    107.8682,
    112.414,
    114.818,
    118.71, // Pd Ag Cd In Sn
    121.76,
    127.6,
    126.90447,
    131.293, // Sb Te I  Xe
...
mod tests {
    ...
    fn test_atomic_mass_table_covers_element_table() {
        ...
        for &(sym, z) in ELEMENTS.iter() {
            let m = atomic_mass(z).unwrap_or_else(|| panic!("no mass for {sym} (Z={z})"));
