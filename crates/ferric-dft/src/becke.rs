...
mod tests {
    ...
    fn h2_at(d: f64) -> Molecule {
        Molecule {
            atoms: vec![
                Atom { symbol: "H".into(), z: 1, x: -d/2.0, y: 0.0, zpos: 0.0, n_core_ecp: 0 },
                Atom { symbol: "H".into(), z: 1, x:  d/2.0, y: 0.0, zpos: 0.0, n_core_ecp: 0 },
            ],
            charge: 0,
            multiplicity: 1,
    ...
    fn becke_weights_grad_finite_difference_ch() {
        ...
        let base = vec![
            Atom { symbol: "C".into(), z: 6, x: 0.0, y: 0.0, zpos: 0.0, n_core_ecp: 0 },
            Atom { symbol: "H".into(), z: 1, x: 2.0, y: 0.0, zpos: 0.0, n_core_ecp: 0 },
        ];
