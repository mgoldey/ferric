//! Davidson subspace eigensolver — local copy in ferric-scf.
//!
//! This duplicates `ferric-rpa::davidson`. We can't import that module
//! here because ferric-rpa depends on ferric-scf (circular dep otherwise).
//! Long-term: factor Davidson into a shared linalg crate. Until then,
//! changes to either copy must be mirrored. See spec:
//! docs/superpowers/specs/2026-05-21-rohf-augmented-hessian-design.md
