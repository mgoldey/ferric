...
fn cpks_dmp2_energy_matches_fd() {
    ...
    let mp2_cfg = ferric_mp2::rimp2::RiMp2Config { frozen_core: 0, memory_budget_bytes: None, ..Default::default() };
    let scf_cfg = RhfConfig { energy_conv: 1e-10, ..Default::default() };
...
fn cpks_c6_attenuation_sweep() {
    ...
    use ferric_mp2::rimp2::RiMp2Config;
    let _ = RiMp2Config { frozen_core: 0, memory_budget_bytes: None, ..Default::default() };
