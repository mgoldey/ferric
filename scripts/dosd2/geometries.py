...
GEOMS = {
    ...
    "so2": (
        "sulfur dioxide C2v (r=1.431, angle=119.3)",
        [
    ...
    "cs2": (
        "carbon disulfide linear (rCS=1.553)",
        [
            ("C", 0.0, 0.0, 0.000000),
            ("S", 0.0, 0.0, 1.553000),
            ("S", 0.0, 0.0, -1.553000),
    ...
    "cos": (
        "carbonyl sulfide linear (rCO=1.157, rCS=1.561)",
        [
            ("C", 0.0, 0.0, 0.000000),
            ("O", 0.0, 0.0, 1.157000),
            ("S", 0.0, 0.0, -1.561000),
    ...
    "cl2": (
        "chlorine (r=1.988)",
        [("Cl", 0.0, 0.0, 0.000000), ("Cl", 0.0, 0.0, 1.988000)],
    ),
    "hbr": (
        "hydrogen bromide (r=1.414)",
        [("Br", 0.0, 0.0, 0.000000), ("H", 0.0, 0.0, 1.414000)],
    ),
    # CONTROLS — saturated / isotropic
    "sih4": (
        "silane Td (rSiH=1.480)",
        [
    ...
    "ccl4": (
        "carbon tetrachloride Td (rCCl=1.766)",
        [
    ...
    "ch3och3": (
        "dimethyl ether C2v (rCO=1.410, COC=111.7)",
        [
