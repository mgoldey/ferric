...
GEOMS = {
    ...
    "c2h2": (
        "acetylene linear (rCC=1.203, rCH=1.063)",
        [
            ("C", 0.0, 0.0, 0.601500),
            ("C", 0.0, 0.0, -0.601500),
            ("H", 0.0, 0.0, 1.664500),
    ...
    "c2h4": (
        "ethylene D2h (rCC=1.339, rCH=1.086, HCH=117.4)",
        [
    ...
    "c2h6": (
        "ethane D3d staggered (rCC=1.536, rCH=1.091)",
        [
    ...
    "hf": (
        "hydrogen fluoride (r=0.917)",
        [("F", 0.0, 0.0, 0.000000), ("H", 0.0, 0.0, 0.917000)],
    ),
    "hcl": (
        "hydrogen chloride (r=1.275)",
        [("Cl", 0.0, 0.0, 0.000000), ("H", 0.0, 0.0, 1.275000)],
    ),
    "h2s": (
        "hydrogen sulfide C2v (r=1.336, angle=92.1)",
        [
    ...
    "o2": (
        "oxygen triplet (r=1.208); multiplicity=3 set in TOML",
        [("O", 0.0, 0.0, 0.000000), ("O", 0.0, 0.0, 1.208000)],
    ),
}
