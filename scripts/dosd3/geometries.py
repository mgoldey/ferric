...
GEOMS = {
    "sif4": (
        "silicon tetrafluoride Td (rSiF=1.554)",
        [
    ...
    "ph3": (
        "phosphine C3v (rPH=1.420, angle=93.5)",
        [
    ...
    "ch3br": (
        "methyl bromide C3v (rCBr=1.933, rCH=1.086)",
        [
    ...
    "br2": (
        "bromine (r=2.281)",
        [("Br", 0.0, 0.0, 0.000000), ("Br", 0.0, 0.0, 2.281000)],
    ),
}
